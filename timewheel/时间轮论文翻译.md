...
However, a variant of this scheme has been implemented in the X-kernel [1].
...
Scheme 7, however, will need a few more instructions in S TART T IMER to find the correct table to insert the timer.
...
If a host had such hardware support, the host software would need time to start
