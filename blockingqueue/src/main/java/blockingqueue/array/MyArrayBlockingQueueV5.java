...
public class MyArrayBlockingQueueV5<E> implements MyBlockingQueue<E> {
    ...
    public void put(E e) throws InterruptedException {
        ...
        try {
            while (count.get() == items.length) {
                // 队列已满时进入休眠
                // 等待队列未满条件得到满足
                System.out.println(Thread.currentThread().getName() + " notFull before await" + Arrays.toString(this.items));
                notFull.await();
                System.out.println(Thread.currentThread().getName() + " notFull after await " + Arrays.toString(this.items));
            ...
            System.out.println(Thread.currentThread().getName() + " putLock unlock" + Arrays.toString(this.items) + " c=" + c);
        ...
        if (c == 0)
            signalNotEmpty();
        System.out.println(Thread.currentThread().getName() + " put end" + Arrays.toString(this.items));
    ...
    private void signalNotEmpty() {
        System.out.println(Thread.currentThread().getName() + " signalNotEmpty " + Arrays.toString(this.items));
    ...
    public E take() throws InterruptedException {
        System.out.println(Thread.currentThread().getName() + " take " + Arrays.toString(this.items) + " sCount=" + sCount.incrementAndGet());
        ...
        try {
            ...
            System.out.println(Thread.currentThread().getName() + " takeLock unlock " + Arrays.toString(this.items) + " c=" + c);
        ...
        System.out.println(Thread.currentThread().getName() + " take end" + Arrays.toString(this.items));
    ...
    private void signalNotFull() {
        System.out.println(Thread.currentThread().getName() + " signalNotFull " + Arrays.toString(this.items));

        // 为了唤醒等待队列未满条件的线程，需要先获取对应的putLock
        putLock.lock();
        try {
            System.out.println(Thread.currentThread().getName() + " signalNotFull notFull.signal " + Arrays.toString(this.items));
