...
public class WorkerEventProcessor<T> implements Runnable,EventProcessor {
    ...
    private final SequenceV3 workGroupSequence;


    public WorkerEventProcessor(MyRingBufferV3<T> myRingBuffer,
                                MyEventConsumer<T> myEventConsumer,
                                SequenceBarrierV3 sequenceBarrier,
                                SequenceV3 workGroupSequence) {
