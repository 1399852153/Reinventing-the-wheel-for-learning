...
public class WorkerEventProcessorV5<T> implements Runnable, EventProcessorV5 {
    ...
    private final SequenceV5 workGroupSequence;


    public WorkerEventProcessorV5(MyRingBufferV5<T> myRingBuffer,
                                  MyEventConsumer<T> myEventConsumer,
                                  SequenceBarrierV5 sequenceBarrier,
                                  SequenceV5 workGroupSequence) {
