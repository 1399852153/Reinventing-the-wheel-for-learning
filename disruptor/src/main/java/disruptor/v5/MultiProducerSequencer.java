...
public class MultiProducerSequencer implements ProducerSequencer {
    ...
    private final SequenceV5 currentMaxProducerSequence = new SequenceV5(-1);
    ...
    public MultiProducerSequencer(int ringBufferSize, final BlockingWaitStrategyV5 blockingWaitStrategyV5) {
    ...
    public long next() {
        do {
            ...
            long gatingSequence = SequenceUtilV5.getMinimumSequence(currentMaxProducerSequenceNum, this.gatingConsumerSequence);
